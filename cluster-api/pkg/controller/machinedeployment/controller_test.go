...
var _ = Describe("MachineDeployment controller", func() {
	var instance MachineDeployment
	var expectedKey string
	var client MachineDeploymentInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = MachineDeployment{}
		instance.Name = "instance-1"
		expectedKey = "machinedeployment-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.ClusterV1alpha1().MachineDeployments("machinedeployment-controller-test-handler")
